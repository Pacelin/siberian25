...
namespace Siberian25.Game.Characters
{
    public static class PlayerConstants
    {
        ...
        public static int ANIMATOR_WALK_HORIZONTAL_BOOL = Animator.StringToHash("walk_horizontal");
        ...
        public static int ANIMATOR_DASH_HORIZONTAL_BOOL = Animator.StringToHash("dash_horizontal");
    }
}